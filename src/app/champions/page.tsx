...
export default function ChampionsPage() {
  ...
  return (
    <div className="bg-gray-900 min-h-screen">
      ...
      {/* Table Header */}
      {/* <div className="grid grid-cols-7 text-center text-xs font-bold text-gray-300 bg-gray-800 py-2 border-b border-[#333] px-2">
        <span className="w-4 md:ml-4">#</span>
        <span>Tướng</span>
        <span>Giá</span>
        <span>Vị trí TB</span>
        <span>Top 4</span>
      ...
      {champions.map((champ: Champion, index: number) => (
        <div
          ...
          className="flex items-center md:text-sm text-xs text-gray-200 py-2 px-2 hover:bg-[#3a3a46] border-b border-black cursor-pointer"
        >
